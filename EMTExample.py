...
gcga = GCGA(slab,variable_types,variable_range,mutations,chances,simple_fitness_function,calculator = EMT(),starting_population = 5,population_size=5,steps=100,similarity_penalty=True)
