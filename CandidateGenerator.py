...
class CandidateGenerator:
    ...
    atomsList: 
        Array containing stoichiometry of atoms to be generated accepts:
            ...
            atoms_array = 
                [[78,78,78,78,78,78,O,O,O,O,O],
                [78,78,78,78,78,78,O,O,O,O,O,O]
                [78,78,78,78,78,78,O,O,O,O,O,O,O]]
    ...
    def __init__(self,slab,atoms_array,ratio_of_covalent_radii=0.7,
        ...
        self.slab = slab
        self.cell_params = self.__get_cell_params(slab)
